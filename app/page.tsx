...
//           <h1 className="text-4xl font-bold mb-4">Welcome to FriendScope (友谱)</h1>
//           <p className="text-xl mb-8">Evaluate your friendships through scientific questionnaires</p>
//           <Link href="/assess">
